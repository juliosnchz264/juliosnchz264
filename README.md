<div align="center">
<img src="https://github.com/juliosnchz264/juliosnchz264/blob/main/github-header-banner%20(1).png?raw=true" alt="Banner de mi perfil" width="100%">
</div>
...
| Focus | Technologies |
| :--- | :--- |
| **Frontend & UI** | `.jsx` `.vue` `.css` (React, Tailwind, CSS) |
| **Backend & Logic** | `.js` `.py` `.php` `.java` (Node.js, Laravel, FastAPI) |
...
![Top Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=juliosnchz264&layout=compact&theme=dracula)

---

*"Code is temporary, good architecture is forever."*
